    ...
    _makeHandlerArray() {
        ...
        function makeHandler(name, op, defaults, nativeSignal) {
            ...
            function signal(nativeHandler, error, ...args) {
                ...
                // Only include additional args (like buffer) if they are valid (not null/undefined)
                // This prevents native assertion failures when xattr returns errors without data
