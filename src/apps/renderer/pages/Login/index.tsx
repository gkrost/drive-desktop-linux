...
export default function Login() {
  ...
  const handleSignInWithBrowser = () => {
    handleOpenURL('https://drive.internxt.com/login?universalLink=true'); // HARDCODED: internxt login page
  };

  const handleCreateAccount = () => {
    handleOpenURL('https://drive.internxt.com/new'); // HARDCODED: internxt account creation page
  };
