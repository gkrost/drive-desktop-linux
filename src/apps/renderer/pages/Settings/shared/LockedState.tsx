    ...
    <div className="flex flex-col items-center p-5" data-testid="locked-state-container">
      <div className="flex flex-col items-center gap-4 text-center" data-testid="locked-state-content">
        <div className="flex flex-col">
          <p className="font-medium text-gray-100">{translate('settings.backups.featureLocked.title')}</p>
          <p className="text-sm text-gray-80">{translate('settings.backups.featureLocked.subtitle')}</p>
        </div>
        <Button onClick={handleOpenPricingPage} className="w-max">
          {translate('settings.backups.featureLocked.action')}
        </Button>
      </div>
    </div>
  );
