...
export const BackupsSVG = () => {
  return (
    <svg
      ...
      height="224">
      <defs>
        <filter id="eDsPAmXJYBu2-filter" x="-150%" width="400%" y="-150%" height="400%">
          <feGaussianBlur id="eDsPAmXJYBu2-filter-drop-shadow-0-blur" in="SourceAlpha" stdDeviation="16,16" />
          <feOffset id="eDsPAmXJYBu2-filter-drop-shadow-0-offset" dx="0" dy="16" result="tmp" />
          <feFlood id="eDsPAmXJYBu2-filter-drop-shadow-0-flood" floodColor="rgba(0,0,0,0.06)" />
          <feComposite id="eDsPAmXJYBu2-filter-drop-shadow-0-composite" operator="in" in2="tmp" />
          <feMerge id="eDsPAmXJYBu2-filter-drop-shadow-0-merge" result="result">
            ...
            <feMergeNode id="eDsPAmXJYBu2-filter-drop-shadow-0-merge-node-2" in="SourceGraphic" />
          </feMerge>
        </filter>
        <filter id="eDsPAmXJYBu3-filter" x="-150%" width="400%" y="-150%" height="400%">
          <feGaussianBlur id="eDsPAmXJYBu3-filter-drop-shadow-0-blur" in="SourceAlpha" stdDeviation="8,8" />
          <feOffset id="eDsPAmXJYBu3-filter-drop-shadow-0-offset" dx="0" dy="-2" result="tmp" />
          <feFlood id="eDsPAmXJYBu3-filter-drop-shadow-0-flood" floodColor="rgba(0,0,0,0.08)" />
          <feComposite id="eDsPAmXJYBu3-filter-drop-shadow-0-composite" operator="in" in2="tmp" />
          <feMerge id="eDsPAmXJYBu3-filter-drop-shadow-0-merge" result="result">
            ...
            <feMergeNode id="eDsPAmXJYBu3-filter-drop-shadow-0-merge-node-2" in="SourceGraphic" />
          </feMerge>
        </filter>
        <filter id="eDsPAmXJYBu4-filter" x="-150%" width="400%" y="-150%" height="400%">
          <feGaussianBlur id="eDsPAmXJYBu4-filter-drop-shadow-0-blur" in="SourceAlpha" stdDeviation="8,8" />
          <feOffset id="eDsPAmXJYBu4-filter-drop-shadow-0-offset" dx="0" dy="-2" result="tmp" />
          <feFlood id="eDsPAmXJYBu4-filter-drop-shadow-0-flood" floodColor="rgba(0,0,0,0.08)" />
          <feComposite id="eDsPAmXJYBu4-filter-drop-shadow-0-composite" operator="in" in2="tmp" />
          <feMerge id="eDsPAmXJYBu4-filter-drop-shadow-0-merge" result="result">
            ...
            <feMergeNode id="eDsPAmXJYBu4-filter-drop-shadow-0-merge-node-2" in="SourceGraphic" />
          </feMerge>
        </filter>
        <filter id="eDsPAmXJYBu5-filter" x="-150%" width="400%" y="-150%" height="400%">
          <feGaussianBlur id="eDsPAmXJYBu5-filter-drop-shadow-0-blur" in="SourceAlpha" stdDeviation="8,8" />
          <feOffset id="eDsPAmXJYBu5-filter-drop-shadow-0-offset" dx="0" dy="-2" result="tmp" />
          <feFlood id="eDsPAmXJYBu5-filter-drop-shadow-0-flood" floodColor="rgba(0,0,0,0.08)" />
          <feComposite id="eDsPAmXJYBu5-filter-drop-shadow-0-composite" operator="in" in2="tmp" />
          <feMerge id="eDsPAmXJYBu5-filter-drop-shadow-0-merge" result="result">
            ...
            <feMergeNode id="eDsPAmXJYBu5-filter-drop-shadow-0-merge-node-2" in="SourceGraphic" />
          </feMerge>
        </filter>
      </defs>
      ...
      <g id="eDsPAmXJYBu7_ts" transform="translate(119.50119,118.50119) scale(0.75,0.75)">
        <path
          id="eDsPAmXJYBu7"
